...
import {loginService, logoutService, registerService, userDetailsService } from '~services/auth';
  ...
  const loginUser = async (data: ILoginProps) => {
    ...
    try {
        ...
        if (loginResponse?.success) {
          ...
          setIsAuth(true);
          setUserData({username: loginResponse?.response?.username, user_id: loginResponse?.response?.id});
